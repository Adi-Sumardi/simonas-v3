...
@endcomponent
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/mahasiswa-data-karakter-store" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="data_komponen_karakter" class="form-control @error('komponen') is-invalid @enderror" name="komponen" required>
