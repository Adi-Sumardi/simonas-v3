    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form method="POST" action="/mahasiswa-kegiatan-asrama-store" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="penyelenggara"
                                            ...
                                            class="text-danger">
                                        <select name="penyelenggara" class="form-control @error('penyelenggara') is-invalid @enderror">
                                ...
                                <div class="col-md-6" hidden>
                                    <div class="form-group">
                                        ...
                                        <input type="attendance" class="form-control @error('attendance') is-invalid @enderror"
