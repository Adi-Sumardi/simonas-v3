                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    ...
                                    <h4 type="button" data-toggle="modal" data-target=".bs-warcob-asgj-modal-xl" class="mb-0">{{$jumlah_warga_percobaan_asgj}}</h4>
                                </div>
                                <div class="col-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wargaPercobaanASGJ as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                                                                                        <img class="avatar-lg mx-auto img-thumbnail rounded-end" src="{{asset('images/user.gif')}}" alt="Card image" height="40" width="40">
                                                                                    </div>
                                                                                    <div class="col-md-10">
                                                                                        <div class="card-body">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    ...
                                    <h4 type="button" data-toggle="modal" data-target=".bs-pengurus-asgj-modal-xl" class="mb-0">{{$jumlah_warga_pengurus_asgj}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($pengurusASGJ as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    ...
                                    <h4 type="button" data-toggle="modal" data-target=".bs-wartap-asgj-modal-xl" class="mb-0">{{$jumlah_warga_tetap_asgj}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wartapASGJ as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2" style="background: linear-gradient(to bottom, #0074b4, #0056a0); border-radius: 10px; text-align: center;">
                            ...
                            <div class="row align-content-center">
                                <div class="col-12">
                                    ...
                                    @endphp
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: {{$persentase_terpakai}}%;" aria-valuenow="{{$jumlah_warga_asgj}}" aria-valuemin="0" aria-valuemax="{{$kapasitas_ideal}}">
                                            {{ $rounded_persentase }}%
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Percobaan</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-warcob-asg-modal-xl" class="mb-0">{{$jumlah_warga_percobaan_asg}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wargaPercobaanASG as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Pengurus</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-pengurus-asg-modal-xl" class="mb-0">{{$jumlah_warga_pengurus_asg}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($pengurusASG as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Tetap</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-wartap-asg-modal-xl" class="mb-0">{{$jumlah_warga_tetap_asg}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wartapASG as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2" style="background: linear-gradient(to bottom, #0074b4, #0056a0); border-radius: 10px; text-align: center;">
                            ...
                            <div class="row align-content-center">
                                <div class="col-12">
                                    ...
                                    @endphp
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: {{$persentase_terpakai}}%;" aria-valuenow="{{$jumlah_warga_asg}}" aria-valuemin="0" aria-valuemax="{{$kapasitas_ideal}}">
                                            {{ $rounded_persentase }}%
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Percobaan</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-warcob-aws-modal-xl" class="mb-0">{{$jumlah_warga_percobaan_aws}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wargaPercobaanAWS as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Pengurus</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-pengurus-aws-modal-xl" class="mb-0">{{$jumlah_warga_pengurus_aws}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($pengurusAWS as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Tetap</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-wartap-aws-modal-xl" class="mb-0">{{$jumlah_warga_tetap_aws}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wartapAWS as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2" style="background: linear-gradient(to bottom, #0074b4, #0056a0); border-radius: 10px; text-align: center;">
                            ...
                            <div class="row align-content-center">
                                <div class="col-12">
                                    ...
                                    @endphp
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: {{$persentase_terpakai}}%;" aria-valuenow="{{$jumlah_warga_aws}}" aria-valuemin="0" aria-valuemax="{{$kapasitas_ideal}}">
                                            {{ $rounded_persentase }}%
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Percobaan</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-warcob-aspuri-modal-xl" class="mb-0">{{$jumlah_warga_percobaan_aspuri}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wargaPercobaanASPURI as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Pengurus</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-pengurus-aspuri-modal-xl" class="mb-0">{{$jumlah_warga_pengurus_aspuri}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($pengurusASPURI as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <p class="mb-2">Warga Tetap</p>
                                    <h4 type="button" data-toggle="modal" data-target=".bs-wartap-aspuri-modal-xl" class="mb-0">{{$jumlah_warga_tetap_aspuri}}</h4>
                                </div>
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        @foreach ($wartapASPURI as $index => $user)
                                                                        <div class="col-lg-6">
                                                                            <div class="card" style="box-shadow: 4px 4px 8px 2px rgba(0, 0, 0, 0.2);">
                                                                                <div class="row no-gutters align-items-center">
                                                                                    <div class="col-md-2">
                        ...
                        <div class="pb-3 border-bottom mt-2" style="background: linear-gradient(to bottom, #0074b4, #0056a0); border-radius: 10px; text-align: center;">
                            ...
                            <div class="row align-content-center">
                                <div class="col-12">
                                    ...
                                    @endphp
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: {{$persentase_terpakai}}%;" aria-valuenow="{{$jumlah_warga_aspuri}}" aria-valuemin="0" aria-valuemax="{{$kapasitas_ideal}}">
                                            {{ $rounded_persentase }}%
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-12">
            <div class="card" style="background-color: rgb(5, 122, 176)">
                <div class="card-body">
                    ...
                    <form action="{{ route('super-eksekutif-summary') }}" method="GET">
                        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row" data-toggle="modal" data-target="#myModal{{$item->id}}">
                                    ...
                                    <div class="modal fade" id="myModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{$item->id}}" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myModalLabel{{$item->id}}">{{$item->nama_kegiatan}}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Tanggal: {{date('d-m-Y', strtotime($item->waktu))}}</p>
                                                    <p>Penyelenggara: {{$item->penyelenggara}}</p>
                                                    <p>Tempat: {{$item->tempat}}</p>
                                                    <p>Keterangan: {{$item->keterangan}}</p>
                                                    <img src="{{ asset('storage/data_file_kegiatan/' . $item->file) }}" class="img-thumbnail" style="height:auto; width:auto;" alt="Gambar kegiatan">
                                                </div>
