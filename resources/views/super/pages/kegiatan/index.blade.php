            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('super-kegiatan-asrama-create')}}" type="button"
                            ...
                            <tbody>
                                @foreach ($kegiatans as $index => $kegiatan)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/super-kegiatan-asrama-delete/{{ $kegiatan->id }}"
                                                method="POST">
                                                ...
                                                <?php endif; ?>
                                                <a href="/super-kegiatan-asrama-detail/{{ $kegiatan->id }}"
                                                    class="btn btn-primary btn-action" data-toggle="tooltip" data-placement="top" title="Detail"><i
                                                        class="far fa-eye"></i></a>
                                                {{--  <a href="/super-kegiatan-asrama-edit/{{ $kegiatan->id }}"
