                    ...
                    {scoreOptions.map(opt => (
                        ...
                        >
                            ...
                            {data.score === opt.value && (
                                <Icon name="check_circle" className="ml-auto text-lg" filled />
                            )}
                        </button>
                    ))}
                </div>
...
export default function MenteeShow({ mentee, hafalan_logs, trend }: Props) {
    ...
    const filtered = filterScore
        ? hafalan_logs.filter(l => l.score === filterScore)
        : hafalan_logs;
                            ...
                            {trend.map((t, i) => {
                                ...
                                return (
                                    <div key={t.label} className="flex-1 flex flex-col items-center gap-1">
                                        ...
                                        <div
                                            className="w-full rounded-t-lg bg-primary-container/20 relative overflow-hidden"
