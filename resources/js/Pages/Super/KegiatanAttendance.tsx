...
export default function KegiatanAttendance({ kegiatan, items, warga }: Props) {
    ...
    function submitManual(e: React.FormEvent) {
        e.preventDefault();
        manualForm.post(`/super/kegiatan/${kegiatan.id}/attendance`, {
            preserveScroll: true,
    ...
    function deleteAttendance(id: number) {
        ...
        router.delete(`/super/kegiatan/${kegiatan.id}/attendance/${id}`, { preserveScroll: true });
    }
    ...
    return (
        <AppLayout>
            ...
            <div className="mb-6">
                <Link href="/super/kegiatan" className="inline-flex items-center gap-2 text-sm text-on-surface-variant hover:text-primary-container transition-colors">
            ...
            <PageHeader
                ...
                breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Kegiatan', href: '/super/kegiatan' }, { label: 'Absensi' }]}
                actions={
