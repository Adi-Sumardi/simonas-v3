            ...
            <table class="table table-bordered table-striped table-hover" id="data-karakter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                                <a href="/admin/penilaian/karakter/detail/<?php echo e($karakter->id); ?>" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                                <a href="/admin/penilaian/karakter/edit/<?php echo e($karakter->id); ?>" class="btn btn-icon btn-success btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Nilai" ><i class="fas fa-file-signature"></i></a>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/admin/pages/penilaian_karakter_index.blade.php ENDPATH**/ ?>