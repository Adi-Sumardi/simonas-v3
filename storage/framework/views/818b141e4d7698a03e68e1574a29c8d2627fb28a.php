<?php $__env->startSection('title'); ?> Form Mask <?php $__env->stopSection(); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Form Mask</h4>
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- form mask -->
    <script src="<?php echo e(URL::asset('/libs/inputmask/inputmask.min.js')); ?>"></script>
    <!-- form mask init -->
    <script src="<?php echo e(URL::asset('/js/pages/form-mask.init.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/form-mask.blade.php ENDPATH**/ ?>