...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">History Penilaian Karakter Islami Warga Asrama</h3>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="/mentor/history/karakter">Karakter</a>
                    </li>
                    <li class="nav-item">
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/history/karakter_index.blade.php ENDPATH**/ ?>