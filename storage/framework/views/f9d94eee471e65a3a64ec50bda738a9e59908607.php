<?php $__env->startSection('title'); ?> Form Repeater <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- form repeater js -->
    <script src="<?php echo e(URL::asset('/libs/jquery-repeater/jquery-repeater.min.js')); ?>"></script>
    <!-- form repeater init -->
    <script src="<?php echo e(URL::asset('/js/pages/form-repeater.init.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/form-repeater.blade.php ENDPATH**/ ?>