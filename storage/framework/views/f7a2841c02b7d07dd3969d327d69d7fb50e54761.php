...
<section class="section">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="/penilaian/leadership/update/<?php echo e($leadership->id); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/leadership/penilaian_edit.blade.php ENDPATH**/ ?>