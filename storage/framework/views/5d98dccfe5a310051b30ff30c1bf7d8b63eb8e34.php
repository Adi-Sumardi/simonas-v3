...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('alumni.common-components.breadcrumb'); ?>
                ...
                <div class="col-6">
                    <div class="card" style="background: linear-gradient(135deg, #007BFF, #0056b3);">
                        <div class="card-body text-white">
                            ...
                            <h4 class="text-white"><?php echo $jumlahtotal; ?> </h4>
                            <div class="row">
                                <div class="col-7">
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4><?php echo $jumlahtotalTahunIni; ?> </h4>
                            <div class="row">
                                <div class="col-7">
                                    <p class="mb-0"><span class="text-success mr-2">  <i class="mdi mdi-arrow-up"></i> </span></p>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <?php $__currentLoopData = $users->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="carousel-row">
                                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="col text-center">
                                                                <img src="<?php echo e(asset('images/' .$user->foto)); ?>" alt="" class="avatar-md mx-auto rounded-circle">
                                                                <p style="font-size: 14px;"><?php echo e($user->nama); ?></p>
                                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-4">
                                    <div class="text-right">
                                        <div><h4 class="mb-0"><?php echo $ASGJ; ?></h4>
                                        </div>
                        ...
                        <div class="pb-3 border-bottom mt-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4">
                                    <div class="text-right">
                                        <div>
                                            <h4 class="mb-0"><?php echo $ASPURI; ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
?>
                            <?php $__currentLoopData = $uniqueProvinceNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alumni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                        <td>
                            <?php echo e($alumni); ?>

                        </td>
                        <td><?php echo e($alumniWithProvince->where('province.name', $alumni)->count()); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            (async () => {
                ...
                const userData = <?php echo json_encode($alumniWithProvince); ?>;
...
const PAPUABARAT = userData.filter(alumni => alumni.province.name === 'PAPUA BARAT').length;
    ...
    <script>
const userData = <?php echo json_encode($AlumniPendidikan); ?>;
...
<script>
const pendidikanData = <?php echo json_encode($users); ?>;
...
<?php echo $__env->make('alumni.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/alumni/index.blade.php ENDPATH**/ ?>