...
<section class="section">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="/mentor/akademik/store" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/akademik/create.blade.php ENDPATH**/ ?>