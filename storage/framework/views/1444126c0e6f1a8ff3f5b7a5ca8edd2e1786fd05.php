...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            <?php echo $__env->make('mentor.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        </nav>
        <div class="main-sidebar main-sidebar-postion">
            <?php echo $__env->make('mentor.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- Main Content -->
        ...
        <footer class="main-footer">
            <?php echo $__env->make('mentor.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </footer>
    </div>
</div>
...
<?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/app.blade.php ENDPATH**/ ?>