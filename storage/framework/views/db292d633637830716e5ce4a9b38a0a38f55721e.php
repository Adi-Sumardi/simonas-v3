            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?php echo e(route('super-komponen-create')); ?>" type="button"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $komponens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komponen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($komponen->kode); ?></td>
                                        <td><?php echo e($komponen->nama_komponen); ?></td>
                                        <td><?php echo e($komponen->aspek); ?></td>
                                        <td>
                                            <form action="/super-komponen-delete/<?php echo e($komponen->id); ?>"
                                                method="POST">
                                                <a href="/super-komponen-edit/<?php echo e($komponen->id); ?>"
...
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/komponen/index.blade.php ENDPATH**/ ?>