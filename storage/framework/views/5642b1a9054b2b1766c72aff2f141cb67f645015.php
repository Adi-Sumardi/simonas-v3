        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="/history/leadership">Leadership</a>
                    </li>
                    <li class="nav-item">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/history/leadership_index.blade.php ENDPATH**/ ?>