...
<section class="section">
    ...
    <div class="card card-primary col-12 col-md-12 col-lg-12" style="overflow: scroll;">
        ...
        <div class="card-body pt-1">
            <form action="/mentor/karakter-update/<?php echo e($karakter->id); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p value="<?php echo e($karakter->nama_penilai); ?>" type="text" name="nama_penilai"></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="role" class="control-label">Nilai:</label><span class="text-danger">*</span>
                                <p value="<?php echo e($karakter->nilai); ?>" type="text" name="nilai">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/karakter/detail.blade.php ENDPATH**/ ?>