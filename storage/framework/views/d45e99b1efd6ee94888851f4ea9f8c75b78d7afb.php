                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>Semester:</td>
                                                <td> :</td>
                                                <td><?php echo e($ipk->semester); ?></td>
                                            </tr>
                                            <tr>
                                                <td>Tahun:</td>
                                                <td> :</td>
                                                <td><?php echo e($ipk->tahun); ?></td>
                                            </tr>
                                            <tr>
                                                <td>Nilai IP:</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($ipk->ip); ?></strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </address>
                          ...
                          <div class="col">
                            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                              <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                ...
                                <br>
                                <address>
                                    <iframe src="<?php echo e(url('/data_file_khs/' . $ipk->file)); ?>" width="100%"
                                        height="300"></iframe>
                                </address>
                              </div>
                            </div>
...
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/ipk/detail.blade.php ENDPATH**/ ?>