            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?php echo e(route('super-kegiatan-leadership-create')); ?>" type="button"
                    ...
                    <div style="overflow: scroll">
                        ...
                        <table class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $leaderships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leadership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + $leaderships->firstItem()); ?></td>
                                        <td><?php echo e($leadership->nama_warga); ?></td>
                                        <td><?php echo e($leadership->komponen); ?></td>
                                        <td><?php echo e(date('d-m-Y', strtotime($leadership->waktu))); ?></td>
                                        <td><?php echo e($leadership->tempat); ?></td>
                                        <td>
                                            <a href="/super-kegiatan-leadership-detail/<?php echo e($leadership->id); ?>"
                        ...
                        Jumlah Data: <?php echo e($leaderships->total()); ?>
...
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/leadership/index.blade.php ENDPATH**/ ?>