            ...
            <table class="table table-bordered table-striped table-hover" id="data-asrama">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                            <form action="/admin/asrama/delete/<?php echo e($asrama->id); ?>" method="POST">
                                <a href="/admin/asrama/edit/<?php echo e($asrama->id); ?>" class="btn btn-icon btn-primary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Edit" ><i class="fas fa-edit"></i></a>
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/admin/pages/index_asrama.blade.php ENDPATH**/ ?>