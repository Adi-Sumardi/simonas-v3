<?php $__env->startSection('title'); ?> Kanban Board <?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
<!-- dragula css -->
<link href="<?php echo e(URL::asset('/libs/dragula/dragula.min.css')); ?>" rel="stylesheet" type="text/css" />
                ...
                <div id="upcoming-task" class="pb-1 task-list">
                    ...
                    <div class="card task-box">
                        <div class="card-body">
                            ...
                            <div>
                                <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Create a Qovex Logo</a></h5>
                ...
                <div id="inprogress-task" class="pb-1 task-list">
                    ...
                    <div class="card task-box">
                        <div class="card-body">
                            ...
                            <div>
                                <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Qovex Dashboard UI</a></h5>
                                <p class="text-muted mb-4">13 Oct, 2019</p>
                            </div>
                ...
                <div id="complete-task" class="pb-1 task-list">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-inline mb-4">
                                <li class="list-inline-item">
                                    <a href="#">
                                        <div>
                                            <img src="/images/small/img-1.jpg" class="rounded" alt="" height="48">
                                        </div>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#">
                                        <div>
                                            <img src="/images/small/img-2.jpg" class="rounded" alt="" height="48">
                                        </div>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#">
                                        <div>
                                            <img src="/images/small/img-3.jpg" class="rounded" alt="" height="48">
                                        </div>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="card task-box">
                        <div class="card-body">
                            ...
                            <div>
                                <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Qovex landing Psd</a></h5>
                                <p class="text-muted mb-4">15 Oct, 2019</p>
                            </div>
...
<!-- dragula plugins -->
<script src="<?php echo e(URL::asset('/libs/dragula/dragula.min.js')); ?>"></script>

<script src="<?php echo e(URL::asset('/js/pages/task-kanban.init.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/tasks-kanban.blade.php ENDPATH**/ ?>