    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form method="POST" action="/super-kegiatan-akademik-store" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="komponen"
                                            class="control-label">Komponen Akademik:</label><span
                                            class="text-danger">
                                        <select name="komponen" id="data_komponen" class="form-control <?php echo e($errors->has('komponen') ? ' is-invalid': ''); ?>">
                                            <option>Pilih Komponen Akademik</option>
                                            <?php $__currentLoopData = $komponens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->nama_komponen); ?>"
                                                    data-kode="<?php echo e($item->kode); ?>"
                                                    data-id="<?php echo e($item->id); ?>" data-aspek="<?php echo e($item->aspek); ?>">
                                                    <?php echo e($item->kode); ?> - <?php echo e($item->nama_komponen); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/akademik/create.blade.php ENDPATH**/ ?>