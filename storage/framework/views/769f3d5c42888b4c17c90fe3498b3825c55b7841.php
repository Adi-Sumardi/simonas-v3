...
<section class="section">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="/admin/kreatif/store" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/admin/pages/kreatif_create.blade.php ENDPATH**/ ?>