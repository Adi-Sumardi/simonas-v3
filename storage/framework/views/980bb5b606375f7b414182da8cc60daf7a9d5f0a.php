...
<section class="section">
    ...
    <div class="card card-primary col-12 col-md-12 col-lg-12" style="overflow: scroll;">
        ...
        <div class="card-body pt-1">
            <form action="/mentor/penilaian/karakter/update/<?php echo e($karakter->id); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="/karakter/file/download/<?php echo e($karakter->file); ?>" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Download File</a>
                            </div>
                        </div>
                    </div>                  
                </div>
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/karakter/penilaian_detail.blade.php ENDPATH**/ ?>