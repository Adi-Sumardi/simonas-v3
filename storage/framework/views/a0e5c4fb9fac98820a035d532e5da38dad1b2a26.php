<?php $__env->startSection('title'); ?> Jquery Knob Chart <?php $__env->stopSection(); ?>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-fgcolor="#3b5de7" data-displayinput="false" value="35">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                            <h5 class="font-size-14 mb-3">Cursor mode</h5>
                            <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#45cb85" value="29">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                            <h5 class="font-size-14 mb-3">Display previous value</h5>
                            <input class="knob" data-width="150" data-min="-100" data-fgcolor="#0caadc" data-displayprevious="true" value="44">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-angleoffset="90" data-linecap="round" data-fgcolor="#eeb902" value="35">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                    ...
                    <div class="col-lg-4">
                        <div class="text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#ff715b" value="29">
                        </div>
                    </div>
                </div>
...
<script src="<?php echo e(URL::asset('/libs/jquery-knob/jquery-knob.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/js/pages/jquery-knob.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/charts-knob.blade.php ENDPATH**/ ?>