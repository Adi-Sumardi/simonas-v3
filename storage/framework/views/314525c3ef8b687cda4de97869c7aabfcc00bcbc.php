<?php $__env->startSection('title'); ?> Email Read <?php $__env->stopSection(); ?>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="email-leftbar card">
            ...
            <div class="mt-2">
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="/images/users/avatar-2.jpg" alt="Generic placeholder image" height="36">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="/images/users/avatar-3.jpg" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="/images/users/avatar-4.jpg" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box">
                ...
                <a href="#" class="media">
                    <img class="d-flex mr-3 rounded-circle" src="/images/users/avatar-6.jpg" alt="Generic placeholder image" height="36">
                    <div class="media-body chat-user-box">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="media mb-4">
                        <img class="d-flex mr-3 rounded-circle avatar-sm" src="/images/users/avatar-2.jpg" alt="Generic placeholder image">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/email-read.blade.php ENDPATH**/ ?>