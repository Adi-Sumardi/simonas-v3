<?php $__env->startSection('title'); ?> Lightbox <?php $__env->stopSection(); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="zoom-gallery">
                    <a class="float-left" href="assets/images/small/img-3.jpg" title="Project 1"><img src="/images/small/img-3.jpg" alt="" width="275"></a>
                    <a class="float-left" href="assets/images/small/img-7.jpg" title="Project 2"><img src="/images/small/img-7.jpg" alt="" width="275"></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/ui-lightbox.blade.php ENDPATH**/ ?>