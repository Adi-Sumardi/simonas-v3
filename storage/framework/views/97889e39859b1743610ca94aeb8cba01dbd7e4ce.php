        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/asrama/dqf">Asrama Putri</a>
                    </li>
                </ul>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/direktur-ketua/dqf.blade.php ENDPATH**/ ?>