    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form method="POST" action="/super-direktur-asrama-update/<?php echo e($asrama->id); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            name="tahun_jabatan" value="<?php echo e($asrama->tahun_jabatan); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            name="direktur" value="<?php echo e($asrama->direktur); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            name="ketua" value="<?php echo e($asrama->ketua); ?>">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/direktur-ketua/edit.blade.php ENDPATH**/ ?>