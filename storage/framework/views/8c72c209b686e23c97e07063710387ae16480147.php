                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="nama_kegiatan" type="text"
                                   class="form-control<?php echo e($errors->has('nama_kegiatan') ? ' is-invalid' : ''); ?>"
                                   name="nama_kegiatan"
                                   tabindex="1" placeholder="Masukan nama kegiatan" value="<?php echo e(old('nama_kegiatan')); ?>"
                                   autofocus required>
                        ...
                        <div class="form-group">
                            <label for="tujuan"
                                ...
                                <textarea id="tujuan" type="keterangan" placeholder="Keterangan Kegiatan"
                                        class="form-control<?php echo e($errors->has('tujuan') ? ' is-invalid': ''); ?>"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                <?php echo e($errors->first('penyelenggara')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                <?php echo e($errors->first('jenis_kegiatan')); ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/admin/pages/create_kegiatan.blade.php ENDPATH**/ ?>