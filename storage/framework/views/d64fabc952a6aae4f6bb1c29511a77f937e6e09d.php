...
<section class="section">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="/mentor/penilaian/leadership/update/<?php echo e($leadership->id); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="komponen">Komponen Kurikulum Leadership:</label><span
                                class="text-danger">*</span>
                            <input value="<?php echo e($leadership->komponen); ?>" type="text" class="form-control" name="komponen">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tempat" class="control-label">Nama Penilai:</label><span
                                class="text-danger">*</span>
                            <input value="<?php echo e($leadership->nama_penilai); ?>" type="text" class="form-control" name="nama_penilai">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="role" class="control-label">Nilai:</label><span
                                    class="text-danger">*</span>
                            <input value="<?php echo e($leadership->nilai); ?>" type="text" class="form-control" name="nilai">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/leadership/penilaian_edit.blade.php ENDPATH**/ ?>