        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown"
               class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="<?php echo e(url ('/uploads/avatars/'.Auth::user()->avatar)); ?>"
                     class="rounded-circle mr-1 thumbnail-rounded user-thumbnail ">
                <div class="d-sm-none d-lg-inline-block">
                    <?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?></div>
            </a>

            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">
                    Pengaturan</div>
                <a class="dropdown-item has-icon edit-profile" href=" <?php echo e(url('/mentor/profile/foto')); ?>" data-id="<?php echo e(\Auth::id()); ?>">
                    <i class="fa fa-user"></i>Edit Photo Profile</a>
...
<?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/header.blade.php ENDPATH**/ ?>