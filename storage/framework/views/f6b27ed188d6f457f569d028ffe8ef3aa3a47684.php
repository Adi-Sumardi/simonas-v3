<?php $__env->startSection('title'); ?> Timeline Page <?php $__env->stopSection(); ?>
                        ...
                        <div class="timeline-box col-lg-4">
                            <div class="timeline-spacing">
                                ...
                                <div class="bg-light p-4 rounded mx-3">
                                    ...
                                    <img src="/images/small/img-2.jpg" alt="" class="img-fluid rounded mr-3" width="100">
                                    <img src="/images/small/img-5.jpg" alt="" class="img-fluid rounded" width="100">
                        ...
                        <div class="timeline-box col-lg-4">
                            <div class="timeline-spacing">
                                ...
                                <div class="bg-light p-4 rounded mx-3">
                                    ...
                                    <p class="text-muted mb-0">Suspendisse tempor porttitor elit non maximus. Sed suscipit, purus in convallis condimentum, risus ex pellentesque sapien, vel tempor arcu dolor ut est. Nam ac felis id mauris fermentum luctus. Etiam iaculis mollis lacus a at posuere nisl pharetra auctor.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Timeline 6 -->
                        ...
                        <div class="timeline-box col-lg-4">
                            <div class="timeline-spacing">
                                ...
                                <div class="bg-light p-4 rounded mx-3">
                                    ...
                                    <p class="text-muted mb-0">Excepturi, obcaecati, quisquam id molestias eaque asperiores voluptatibus cupiditate error assumenda delectus odit similique earum voluptatem doloremque dolorem ipsam quae rerum quis. Odit, itaque, deserunt corporis vero ipsum nisi repellat ... <a href="#">Read more</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- Timeline 5 -->
                        ...
                        <div class="timeline-box col-lg-4">
                            <div class="timeline-spacing">
                                ...
                                <div class="bg-light p-4 rounded mx-3">
                                    ...
                                    <p class="text-muted mb-0">printing and typesetting industry. been the industry'scrambled it to make a type specimen book.</p>
                                    <button type="button" class="btn btn-info btn-rounded waves-effect waves-light mt-4">See more detail</button>
                                </div>
                            </div>
                        </div>
                        <!-- Timeline 4 -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/pages-timeline.blade.php ENDPATH**/ ?>