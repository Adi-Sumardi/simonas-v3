<?php $__env->startSection('title'); ?> Session Timeout <?php $__env->stopSection(); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-header">Session timeout and keep-alive control with a nice Bootstrap warning dialog.</p>
...
<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('/libs/curiosityx/curiosityx.min.js')); ?>"></script>
<!-- Session timeout js -->
<script src="<?php echo e(URL::asset('/js/pages/session-timeout.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/ui-session-timeout.blade.php ENDPATH**/ ?>