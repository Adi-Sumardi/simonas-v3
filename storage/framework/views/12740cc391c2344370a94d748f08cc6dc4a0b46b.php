    ...
    <div class="section-body">
        <div class="row">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/alumni/kegiatan/aws">AWS</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/alumni/kegiatan/yapi">YAPI</a>
                </li>
            </ul>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover" id="data-kegiatan">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                            
                                <a href="/alumni/kegiatan-detail/<?php echo e($kegiatan->id); ?>" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info-circle"></i></a>
                        </td>
                    </tr>       
...
<?php echo $__env->make('alumni.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/alumni/pages/kegiatan_yapi.blade.php ENDPATH**/ ?>