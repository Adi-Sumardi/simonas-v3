            ...
            <table class="table table-bordered table-striped table-hover" id="data-alumni">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                           
                            <form action="/alumni-delete/<?php echo e($user->id); ?>" method="POST">
                                <a href="/alumni-detail/<?php echo e($user->id); ?>" class="btn btn-icon btn-secondary btn-action btn-sm" data-toggle="tooltip" title="" data-original-title="Detail" ><i class="fas fa-info"></i></a>
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/alumni/pages/index.blade.php ENDPATH**/ ?>