        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">
                    Pengaturan</div>
                <a class="dropdown-item has-icon edit-profile" href=" <?php echo e(url('/admin/profile/foto')); ?>" data-id="<?php echo e(\Auth::id()); ?>">
...
<?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/admin/pages/header.blade.php ENDPATH**/ ?>