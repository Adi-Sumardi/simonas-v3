...
<section class="section">
    ...
    <div class="card card-primary col-12 col-md-12 col-lg-12" style="overflow: scroll;">
        ...
        <div class="card-body pt-1">
            <form action="/penilaian/karakter/update/<?php echo e($karakter->id); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/karakter/penilaian_detail.blade.php ENDPATH**/ ?>