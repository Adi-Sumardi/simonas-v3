<?php $__env->startSection('title'); ?> Range Slider <?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
<!-- Lightbox css -->
<link href="<?php echo e(URL::asset('/libs/ion-rangeslider/ion-rangeslider.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<!-- Ion Range Slider-->
<script src="<?php echo e(URL::asset('/libs/ion-rangeslider/ion-rangeslider.min.js')); ?>"></script>
<!-- Range slider init js-->
<script src="<?php echo e(URL::asset('/js/pages/range-sliders.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/ui-rangeslider.blade.php ENDPATH**/ ?>