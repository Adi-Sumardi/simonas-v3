...
<div class="vertical-menu">
    ...
    <div class="h-100">
        ...
        <div class="user-wid text-center py-4">
            <div class="user-img">
                <img src="<?php echo e(url('/data_photo/' . Auth::user()->avatar)); ?>" alt="" class="avatar-md mx-auto rounded-circle">
            </div>

            <div class="mt-3">

                <a href="#" class="text-dark font-weight-medium font-size-16"><?php echo e(\illuminate\Support\Facades\Auth::user()->name); ?></a>
                <p class="text-body mt-1 mb-0 font-size-13"><?php echo e(\illuminate\Support\Facades\Auth::user()->asrama); ?></p>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/super-kegiatan-reporting">Reporting</a></li>
                ...
                <li>
                    <a href="/super-laporan" class=" waves-effect">
                ...
                <li>
                    <a href="<?php echo e(url('logout')); ?>" onclick="event.preventDefault(); localStorage.clear();  document.getElementById('logout-form').submit();" class=" waves-effect">
...
<!-- Left Sidebar End --><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/sidebar.blade.php ENDPATH**/ ?>