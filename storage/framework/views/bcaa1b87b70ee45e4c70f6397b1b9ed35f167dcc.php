        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/mentor/penilaian/leadership/aws">AWS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/mentor/penilaian/leadership/dqf">Asrama Putri</a>
                    </li>
                </ul>
            </div>
        </div>
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/leadership/nilai_dqf.blade.php ENDPATH**/ ?>