<?php $__env->startSection('title'); ?> General UI <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

     <?php $__env->startComponent('common-components.breadcrumb'); ?>
         <?php $__env->slot('title'); ?> General UI  <?php $__env->endSlot(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <p class="card-title-desc">Use the <code>.badge-pill</code> modifier class to make badges more rounded (with a larger <code>border-radius</code> and additional horizontal <code>padding</code>). Useful if you miss the badges from v3.</p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="button-items">
                    ...
                    <button type="button" class="btn btn-secondary waves-effect" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on bottom
                    </button>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <p class="card-title-desc">Pagination links are customizable for different circumstances. Use <code>.disabled</code> for links that appear un-clickable and <code>.active</code> to indicate the current page.</p>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mt-4">
                            ...
                            <p class="card-title-desc">Fancy larger or smaller pagination? Add <code>.pagination-lg</code> or <code>.pagination-sm</code> for additional sizes.
                            </p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/ui-general.blade.php ENDPATH**/ ?>