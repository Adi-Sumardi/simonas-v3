<?php $__env->startSection('title'); ?> Chartjs <?php $__env->stopSection(); ?>
...
<div class="row">
    ...
    <!-- Chart JS -->
    <script src="<?php echo e(URL::asset('/libs/chart-js/chart-js.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/js/pages/chartjs.init.js')); ?>"></script>

    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/charts-chartjs.blade.php ENDPATH**/ ?>