            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <ul class="nav nav-tabs shadow-sm p-3 mb-5 bg-white rounded">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/kartu/dqf">Asrama Putri</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/kartu/dqf.blade.php ENDPATH**/ ?>