...
<section class="section">
    ...
    <div class="card card-primary col-12 col-md-12 col-lg-12" style="overflow: scroll;">
        ...
        <div class="card-body pt-1">
            <form action="/mentor/leadership-update/<?php echo e($leadership->id); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('mentor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/mentor/pages/leadership/detail.blade.php ENDPATH**/ ?>