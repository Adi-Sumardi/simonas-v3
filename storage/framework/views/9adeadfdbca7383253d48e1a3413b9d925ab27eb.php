                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Asrama</td>
                                                <td> :</td>
                                                <td><?php echo e($kreatif->asrama); ?></td>
                                            </tr>
                                            <tr>
                                                <td>Komponen</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($kreatif->komponen); ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($kreatif->kegiatan); ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Waktu</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($kreatif->waktu); ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Tempat Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($kreatif->tempat); ?></strong></td>
                                            </tr>
                                            <tr>
                                                <td>Uraian Kegiatan</td>
                                                <td> :</td>
                                                <td> <strong> <?php echo e($kreatif->keterangan); ?></strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </address>
                          ...
                          <div class="col">
                            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                              <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                ...
                                <br>
                                <address>
                                    <img src="<?php echo e(url('/data_file_kreatif/' . $kreatif->file)); ?>" class="img-thumbnail" style="height:auto; width:100%; vertical-align:middle; max-width:250px;" alt="">
                                </address>
                              </div>
                            </div>
                          </div>
...
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/kreatif/detail.blade.php ENDPATH**/ ?>