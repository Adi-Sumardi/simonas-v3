    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form method="POST" action="/super-komponen-update/<?php echo e($komponens->id); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            name="kode" value="<?php echo e($komponens->kode); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            name="nama_komponen" value="<?php echo e($komponens->nama_komponen); ?>">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('super.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/pages/komponen/edit.blade.php ENDPATH**/ ?>