<?php $__env->startSection('title'); ?> Flot charts <?php $__env->stopSection(); ?>
...
<!-- flot plugins -->
<script src="<?php echo e(URL::asset('/libs/flot-charts/flot-charts.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/libs/flot.curvedlines/flot.curvedlines.min.js')); ?>"></script>

<!-- flot init -->
<script src="<?php echo e(URL::asset('/js/pages/flot.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/super/layouts/default/charts-flot.blade.php ENDPATH**/ ?>