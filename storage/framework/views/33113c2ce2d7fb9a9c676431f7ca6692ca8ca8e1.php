                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                <h5 class="text-white font-size-20"> <?php echo e(__('Register')); ?> SIMONAS</h5>
                            ...
                            <div class="p-2">
                                <form method="POST" action="<?php echo e(route('register')); ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="useremail"><?php echo e(__('E-Mail')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="no_telp"><?php echo e(__('Nomor Telepon')); ?></label>
                                        <input type="number" name="no_telp" value="<?php echo e(old('no_telp')); ?>" required class="form-control <?php $__errorArgs = ['no_telp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus placeholder="Enter Phone Number">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="asrama"><?php echo e(__('Asrama')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="tgl_masuk"><?php echo e(__('Tanggal Masuk Asrama')); ?></label>
                                        <input type="date" name="tgl_masuk" value="<?php echo e(old('tgl_masuk')); ?>" required class="form-control <?php $__errorArgs = ['tgl_masuk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus placeholder="Register Date Dormitory">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-primary btn-block waves-effect waves-light" id="register" type="submit"> <?php echo e(__('Register')); ?></button>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yapi/Adi/appdev/simonas-app/resources/views/auth/register.blade.php ENDPATH**/ ?>